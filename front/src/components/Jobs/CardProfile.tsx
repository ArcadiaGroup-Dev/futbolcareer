          ...
          <div className="transition-opacity duration-300">
            <div className="flex items-start">
              ...
              <div className="ml-4">
                ...
                {Array.isArray(profile.puesto) && profile.puesto.length > 0 ? (
                  profile.puesto.map(
                    (
                      pos: { position: string; experience: number },
                      index: number
                    ) => (
                      <div key={index} className="text-gray-700">
                        <p>
                          <strong>{pos.position}:</strong> {pos.experience} años
                          de experiencia
                        </p>
                      </div>
                    )
                  ...
                  <p className="text-gray-600">
                    Aún no tiene experiencias agregadas
                  </p>
                )}
              </div>
            </div>
