  ...
  return (
    <div className="max-w-6xl mt-24 mx-auto p-4 bg-gray-100  text-gray-700 rounded-lg shadow-lg shadow-gray-400  border-2 hover:cursor-pointer ">
      ...
      >
        ...
        {/*  LA PINCHE DESCRIPCION */}

        <div className="flex flex-col md:col-span-2">
          <label className="text-sm font-bold mb-2">Descripción</label>
          <textarea
            className="p-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-green-500 text-gray-600"
            value={formData.description}
            onChange={handleDescriptionChange}
            placeholder="Descripción detallada de la oferta laboral"
            rows={4}
          />
        </div>
        ...
        <div className="flex flex-col">
          <label className="text-sm font-bold  mb-2">Rol</label>
          <select
